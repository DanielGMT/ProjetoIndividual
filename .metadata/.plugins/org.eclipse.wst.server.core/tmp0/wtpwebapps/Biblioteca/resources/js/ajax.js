...
/*
* Processa o pedido, solicitações HTTP Ajax a ser recebido pelo Rest.
*/
 ...
 * propriedades com valores, se isso se confirmar retorna o objeto cfg.
 ...
 * notem também a chamada à função isObject(cfg.data) que repassa comoparâmetro cfg.data
 * para saber se os dados apontados por cfg tratem-se de um array de dados,
...
SENAI.ajax.post = function(cfg){
	 ...
	 * ajaxRequestDefault().
	 * Esta inicialização e pedido são repassados para o objeto def que,
	 ...
	 * stado do objeto cfg recebido, ou seja, o identificador cfg
	 ...
	 * solicitação, perdido HTTP, Ajax seja enviada para em recurso Rest
	 */
